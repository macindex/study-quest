// js/main-drap.js - Versão CSP-Safe para DRAP
let questions = [];
...
async function loadQuestions() {
    try {
        ...
        console.log(`Carregadas ${questions.length} questões de DRAP`);
...
function resetStats() {
    ...
    alertDiv.innerHTML = `
        Estatísticas de DRAP zeradas com sucesso!
